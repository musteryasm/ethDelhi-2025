        ...
        <div className="text-center z-10">
          ...
          >
            <h1 className="font-orbitron text-6xl md:text-8xl font-black mb-6 text-glow">
              CYBER<span className="text-cyber-green">FIT</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-gray-300 max-w-2xl mx-auto">
              Stake crypto. Complete challenges. Earn rewards.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <GlassCard glowEffect>
              <div className="text-center">
                ...
                <h3 className="font-orbitron text-xl font-bold mb-3">Smart Staking</h3>
            ...
            <GlassCard glowEffect>
              <div className="text-center">
                ...
                <h3 className="font-orbitron text-xl font-bold mb-3">AI Verification</h3>
                <p className="text-gray-300">
            ...
            <GlassCard glowEffect>
              <div className="text-center">
                ...
                <h3 className="font-orbitron text-xl font-bold mb-3">Prize Pools</h3>
                <p className="text-gray-300">
