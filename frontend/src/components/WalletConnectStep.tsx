...
const WalletConnectStep = ({ isConnecting, onConnect, onBack }: WalletConnectStepProps) => {
  return (
    <GlassCard className="text-center">
      ...
      <p className="text-gray-300 text-sm mb-6">
        Connect your MetaMask wallet to access the CyberFit ecosystem
      </p>
      ...
      <NeonButton onClick={onConnect} className="w-full mb-4" size="lg" disabled={isConnecting}>
        {isConnecting ? (
